        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info rounded-pill px-3" href="home.php?page=pasien&id=<?php echo $data['id'] ?>">Ubah</a>
                            <a class="btn btn-danger rounded-pill px-3" href="home.php?page=pasien&id=<?php echo $data['id'] ?>&aksi=hapus">Hapus</a>
                        </td>
                    </tr>
                <?php
                }
            ...
            <?php
                if (isset($_POST['simpan'])) {
                    ...
                    echo "<script> 
                            document.location='home.php?page=pasien';
                            </script>";
                }
